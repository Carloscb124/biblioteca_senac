  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="menu">
      <ul class="navbar-nav mx-auto header-menu">
        ...
        <li class="nav-item">
          <a class="nav-link <?= strpos($_SERVER['REQUEST_URI'],'livros')!==false?'active':'' ?>"
        ...
        <li class="nav-item">
          <a class="nav-link <?= strpos($_SERVER['REQUEST_URI'],'usuarios')!==false?'active':'' ?>"
        ...
        <li class="nav-item">
          <a class="nav-link <?= strpos($_SERVER['REQUEST_URI'],'emprestimos')!==false?'active':'' ?>"
